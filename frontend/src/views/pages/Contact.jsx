                        ...
                        <div className="col-12 col-xl-9 mx-auto">
                            ...
                            <div className="row mt-5">
                                <div className="col-12 col-sm-6 mb-5 mb-sm-0">
                                    ...
                                    <p>
                                        Call:{" "}
                                        <a href="tel:+1234567890" className="text-reset">
                                            <u>+123 4567 890 (Toll-free)</u>
                                        </a>
                                    </p>
                                    <p>
                                        Email:{" "}
                                        <a href="mailto:desphixs@gmail.com" className="text-reset">
                                ...
                                <div className="col-12">
                                    ...
                                    <form className="contact-form" id="contact-form" name="contactform" method="POST">
                                        <div className="row">
                                            ...
                                            <div className="col-12">
                                                <div className="mb-3">
                                                    <textarea required id="con-message" name="message" cols={40} rows={6} className="form-control" placeholder="Message" />
                                                </div>
                                            </div>
