                                ...
                                {[
                                    {
                                        ...
                                        img: "https://images.unsplash.com/photo-1542909168-82c3e7fdca5c?q=80&w=1000&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OHx8ZmFjZXxlbnwwfHwwfHx8MA%3D%3D",
                                    },
                                    {
                                        name: "Frances Guerrero",
                                        role: "Managing Editor",
                                        img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRVSPtLWfht2p015onFngljcoIuA9xc8h3RLA&usqp=CAU",
                                    },
                                    {
                                        name: "Larry Lawson",
                                        role: "Director Graphics",
                                        img: "https://www.byrdie.com/thmb/aZWxblVz7BMxeObHtJEKX_ddV3c=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/Stocksy_txpce733110Uae300_Medium_4082489-df45caed45cd449b806f9ce16a20804a.jpg",
                                    },
                                    {
                                        name: "Louis Crawford",
                                        role: "Editor, Coverage",
                                        img: "https://static.vecteezy.com/system/resources/previews/036/442/773/non_2x/ai-generated-portrait-of-a-young-japanese-man-no-facial-expression-half-body-shot-facing-the-camera-isolated-white-background-ai-generative-free-photo.jpg",
                                    },
                                ].map((member, idx) => (
                                ...
                                {[
                                    {
                                        ...
                                        img: "https://www.aspistrategist.org.au/wp-content/uploads/2023/11/GettyImages-467714941-1024x764.jpg",
                                        desc: "Perceived end knowledge certainly day sweetness why cordially. Ask a quick six seven offer see among.",
                                    },
                                    {
                                        title: "Commercial services",
                                        img: "https://www.varletmachines.com/sites/default/files/styles/large/public/2022-04/Commercial.png?itok=jE81FZ_E",
                                        desc: "Speedily say has suitable disposal add boy. On forth doubt miles of child. Exercise joy man children rejoiced.",
                                    },
                                    {
                                        title: "Public services",
                                        img: "https://www.columbiasouthern.edu/media/azmjow33/fire-ems-cj-public-service.jpg",
                                        desc: "Yet uncommonly his ten who diminution astonished. Demesne new manners savings staying had.",
                                    },
                                ].map((service, idx) => (
                                    <div className="col-12 col-md-6 col-lg-4 mb-4" key={idx}>
                                        <img className="rounded" style={{ width: "100%", height: "170px", objectFit: "cover" }} src={service.img} alt={service.title} />
