                        ...
                        <div className="col-12 col-md-6 col-xxl-4">
                            <div className="card border h-100">
                                <div className="card-header border-bottom d-flex justify-content-between align-items-center p-3">
                                    <h5 className="card-header-title mb-0">All Posts ({stats.posts || 0})</h5>
                                </div>
                                <div className="card-body p-3">
                                    <div className="row">
                                        {posts?.slice(0, 3).map((p, index) => (
                                            <div className="col-12" key={p.id || index}>
                                                <div className="d-flex position-relative">
                                                    ...
                                                    <div className="ms-3">
                                                        <Link to={`/posts/${p.id}/`} className="h6 stretched-link text-decoration-none text-dark">
                                                            {p.title}
                                                        </Link>
                                ...
                                <div className="card-body p-3">
                                    <div className="row">
                                        {comments?.slice(0, 3).map((c, index) => (
                                            <div className="col-12" key={c.id || index}>
                                                <div className="d-flex align-items-center position-relative">
                                                    ...
                                                    <div className="ms-3">
                                                        <p className="mb-1">
                                                            <span className="h6 text-dark">{c.comment}</span>
                                                        </p>
                                    ...
                                    <div className="custom-scrollbar" style={{ maxHeight: 350, overflowY: "auto" }}>
                                        <div className="row">
                                            {noti?.slice(0, 3)?.map((n, index) => (
                                                <div className="col-12" key={n.id || index}>
                                                    ...
                                                    <tr key={p.id || index}>
                                                        <td>
                                                            <h6 className="mt-2 mt-md-0 mb-0 ">
                                                                <Link to={`/posts/${p.id}/`} className="text-dark text-decoration-none">
                                                                    {p?.title}
                                                                </Link>
                                                            </h6>
                                                        </td>
                                                        ...
                                                        <td>
                                                            <div className="d-flex gap-2">
                                                                <button className="btn-round mb-0 btn btn-danger" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete">
