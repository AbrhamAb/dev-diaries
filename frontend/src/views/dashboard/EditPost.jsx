...
function EditPost() {
    ...
    const handleCreatePost = async (e) => {
        ...
        formdata.append("image", post.image.file || post.image);
                ...
                <div className="container">
                    <div className="row mt-0 mt-md-4">
                        <div className="col-12">
                            <section className="py-4 py-lg-6 bg-primary rounded-3 mb-4">
                                <div className="container">
                                    <div className="row">
                                ...
                                <div className="card mb-3">
                                    ...
                                    <div className="card-body">
                                        ...
                                        <div className="mb-3">
                                            ...
                                            <textarea value={post.description || ""} onChange={handleCreatePostChange} name="description" className="form-control" cols="30" rows="10"></textarea>
