...
def category_list(request):
    ...
    data = [{"name": cat.title, "slug": cat.slug} for cat in categories]
...
def post_list(request):
    ...
    # Serialize your posts here (use DRF serializer or manual)
    data = [
        {
            "id": post.id,
            "title": post.title,
            ...
            "category": {
                "title": post.category.title if post.category else "",
